                    ...
                    <div className={'form'}>
                        <div className="d-flex w-100">
                            <div className={'flex-grow-1'} onClick={handleSearchFocus}>
                                <div className={'p-3   bg-light border d-flex'} style={{borderRadius:12}}><i className={'fa fa-search'}></i> <span className={'ps-3 d-inline-block'}> {`Search in ${locationname}`}</span></div>
